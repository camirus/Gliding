...
public class DateUtils {
    ...
    /**
     * <p>Checks if (date1 - days) and date2 are on the same day ignoring time.</p>
     * @param date1  the first date, not altered, not null
     * @param date2  the second date, not altered, not null
     * @param days nr of days
     * @return true if they represent the same day
     * @throws IllegalArgumentException if either date is <code>null</code>
     */
    public static boolean isXDaysBeforeDay(Date date1, Date date2, int days) {
        if (date1 == null || date2 == null) {
            throw new IllegalArgumentException("The dates must not be null");
        }
        Calendar cal1 = Calendar.getInstance();
        ...
        Calendar cal2 = Calendar.getInstance();
        cal2.setTime(date2);
        return isXDaysBeforeDay(cal1, cal2, days);
    }
    ...
    /**
     * <p>Checks if cal2 - days represent the same day as cal1.</p>
     * @param cal1  the first calendar, not altered, not null
     * @param cal2  the second calendar, not altered, not null
     * @param days number of days
     * @return true if (cal2 - days nr of days) represent the same day as cal1
     * @throws IllegalArgumentException if either calendar is <code>null</code>
     */
    public static boolean isXDaysBeforeDay(Calendar cal1, Calendar cal2, int days) {
        if (cal1 == null || cal2 == null) {
            throw new IllegalArgumentException("The dates must not be null");
        }
    ...
    public static boolean isYesterday(Date date) {
        return isXDaysBeforeDay(date, Calendar.getInstance().getTime(),1);
    }
    
    /**
     * <p>Checks if a date is two days before today.</p>
     * @param date the date, not altered, not null.
     * @return true if the date is two days before today.
     * @throws IllegalArgumentException if the date is <code>null</code>
     */
    public static boolean isTwoDaysBeforeToday(Date date) {
        return isXDaysBeforeDay(date, Calendar.getInstance().getTime(),2);
    }
    ...
    /** 
     * Returns the date with hour and minute set to equivalent parameters. 
     */
